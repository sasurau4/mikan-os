...
constexpr uint32_t Color(int deg)
{
    if (deg <= 30)
    {
        return (255 * deg / 30 << 8) | 0xff'00'00;
    }
    else if (deg <= 60)
    {
        return (255 * (60 - deg) / 30) << 16 | 0x00'ff'00;
    }
    else if (deg <= 90)
    {
        return (255 * (deg - 60) / 30) | 0x00'ff'00;
    }
    else if (deg <= 120)
    {
        return (255 * (120 - deg) / 30) << 8 | 0x00'00'ff;
    }
    else if (deg <= 150)
    {
        return (255 * (deg - 120) / 30) << 16 | 0x00'00'ff;
    }
    else
    {
        return (255 * (180 - deg) / 30) | 0xff'00'00;
    }
};
